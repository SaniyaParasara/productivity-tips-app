    // This Jenkinsfile defines a declarative pipeline to build, test, and deploy a Docker container.
    // It's designed to be used with the Jenkins Docker pipeline plugin.
